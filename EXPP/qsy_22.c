...
void Update_LED(){
	...
	if(!apm) { if(pm) Flash("D1");	else Flash("D3"); }
...
void UnFlash(char* LED_Name) {
	...
	if (isStringEqual(LED_Name, "D3"))GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_4, 0);
	if (isStringEqual(LED_Name, "D4"))GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0, 0);
}
...
void Twinkle_Minute(){
	...
	}while(Button_Status == 4 && keySW_pressed[5] == 0 && keySW_pressed[6] == 0 && !nightflag);
...
void Twinkle_Hour(){
	...
	}while(Button_Status == 4 && keySW_pressed[3] == 0 && keySW_pressed[4] == 0 && !nightflag);
...
void Twinkle_Day(){
	...
	}while(Button_Status == 5 && keySW_pressed[3] == 0 && keySW_pressed[4] == 0 && !nightflag);
...
void Twinkle_Month(){
	...
	}while(Button_Status == 5  && keySW_pressed[5] == 0 && keySW_pressed[6] == 0 && !nightflag);
