...
void S800_I2C0_Init(void)
{
  ...
  GPIOPinTypeI2C(GPIO_PORTB_BASE, GPIO_PIN_3);//I2C½«GPIO_PIN_3ÓÃ×÷SDA
	...
	I2CMasterEnable(I2C0_BASE);																					//Ê¹ÓÃI2C0Ö÷»úÄ£Ê½ 
...
uint8_t I2C0_WriteByte(uint8_t DevAddr, uint8_t RegAddr, uint8_t WriteData)
{
	...
	I2CMasterSlaveAddrSet(I2C0_BASE, DevAddr, false);//ÉèÖÃ´Ó»úµØÖ·¡£false±íÊ¾Ö÷»úÐ´´Ó»ú£¬true±íÊ¾Ö÷»ú¶Á´Ó»ú
	I2CMasterDataPut(I2C0_BASE, RegAddr);//ÉèÖÃ×ÓµØÖ·£¬Ö÷»úÐ´Éè±¸¼Ä´æÆ÷µØÖ
	...
	I2CMasterDataPut(I2C0_BASE, WriteData);//ÉèÖÃÊý¾Ý×Ö½Ú
