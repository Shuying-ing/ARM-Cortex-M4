...
void Display_Time() {
	...
	Display_1digit_7segment_int(minute_10, 0);
	Display_1digit_7segment_int(minute_1, 1);
	Display_1digit_7segment_int(16, 2);
	Display_1digit_7segment_int(second_10, 3);
	Display_1digit_7segment_int(second_1, 4);
}
